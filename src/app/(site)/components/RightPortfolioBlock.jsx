...
export default function RightPortfolioBlock(project){
  return (
    <div key={project.name} className="mt-[72px] md:mt-[94px] grid md:grid-cols-2 md:gap-x-[69px] lg:gap-x-[125px]">
        <div className="place-self-center md:order-last">
        ...
        <div className="lg:ml-[94px] flex flex-col justify-center md:max-w-[350px] border-t border-b border-[#33323D]/15 mt-8 md:mt-0 py-6 md:py-0">
